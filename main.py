    """
    Url Shortener Api Kav7avl
    =========================
    Open-source API service that proxys data between clients and backends.
    ...
    APP_NAME    = "Url Shortener Api Kav7avl"
    APP_VERSION = "1.0.0"
...
return app
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Open-source API service that proxys data between clients and backends.")
